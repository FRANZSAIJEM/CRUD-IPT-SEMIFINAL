...
class InvestorController extends Controller
{
    ...
    public function subedit(Investor $investor){
        return view ('investors.subedit',[
            'investor' => $investor
        ]);
    }
    ...
    public function subconfirm(Investor $investor){
        return view ('investors.confirm',[
            'investor' => $investor
    ...
    public function store(Request $request){
        ...
        return redirect ('/')->with('info', 'A new investor has beed Added');
